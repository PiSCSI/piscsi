...
class SetableGpiobusRaspberry : public GPIOBUS_RPi_bcm
{
  public:
...
TEST(GpiobusRaspberry, GetDtRanges)
{
    ...
    EXPECT_EQ(0x44556677, GPIOBUS_RPi_bcm::bcm_host_get_peripheral_address());
    ...
    CreateTempFileWithData(soc_ranges_file, data);
    EXPECT_EQ(0x8899AABB, GPIOBUS_RPi_bcm::bcm_host_get_peripheral_address());
    DeleteTempFile("/proc/device-tree/soc/ranges");
    ...
    CreateTempFileWithData(soc_ranges_file, data);
    EXPECT_EQ(0x20000000, GPIOBUS_RPi_bcm::bcm_host_get_peripheral_address());
    DeleteTempFile("/proc/device-tree/soc/ranges");

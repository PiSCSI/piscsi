...
function showNetworkMenu() {
    echo "You have both wired and wireless network interfaces."
    echo "Please choose the interface you would like to configure"
    echo "1. Wired"
    echo "2. Wireless"
}

function runNetworkChoice() {
    case $1 in
          1)
...
function readNetworkChoice() {
   choice=-1

   until [ $choice -ge "1" ] && [ $choice -le "2" ]; do
       echo -n "Enter your choice (1-2) or CTRL-C to exit: "
       read -r choice
   done

   runNetworkChoice "$choice"
}

...
alias rascsirebuild='cd ~/RASCSI/src/raspberrypi && sudo systemctl stop rascsi && make all DEBUG=1 -j && sudo make install && sudo systemctl daemon-reload && sudo systemctl start rascsi && rascsiaddnuvo 4'

...
// Temporary? Trick to make the ID understand that RASCSI is set
#ifndef RASCSI
#define RASCSI
#endif // RASCSI
...
//---------------------------------------------------------------------------
#ifdef RASCSI
SCSIMONDEV::SCSIMONDEV() : SASIDEV()
#else
SCSIMONDEV::SCSIMONDEV(Device *dev) : SASIDEV(dev)
#endif
{
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::Reset()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
BUS::phase_t FASTCALL SCSIMONDEV::Process()
{
	ASSERT(this);
	printf("SCSIMONDEV::Process() %d\n", ctrl.id);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::BusFree()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::Selection()
{
	DWORD id;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::Execute()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::MsgOut()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::Error()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdInquiry()
{
	Disk *disk;
	int lun;
	DWORD major;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdModeSelect()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdModeSense()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdStartStop()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdSendDiag()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdRemoval()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdReadCapacity()
{
	DWORD lun;
	int length;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdRead10()
{
	DWORD lun;
	DWORD record;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdWrite10()
{
	DWORD lun;
	DWORD record;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdSeek10()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdVerify()
{
	DWORD lun;
	BOOL status;
	DWORD record;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdSynchronizeCache()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdReadDefectData10()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdReadToc()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdPlayAudio10()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdPlayAudioMSF()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdPlayAudioTrack()
{
	DWORD lun;
	BOOL status;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdModeSelect10()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdModeSense10()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdGetMessage10()
{
	DWORD lun;
	SCSIBR *bridge;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::CmdSendMessage10()
{
	DWORD lun;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::SendNext()
{
	ASSERT(this);
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::Receive()
{
	DWORD data;
...
//
//---------------------------------------------------------------------------
void FASTCALL SCSIMONDEV::ReceiveNext()
#endif	// RASCSI
{
#ifdef RASCSI
	int len;
...
//
//---------------------------------------------------------------------------
BOOL FASTCALL SCSIMONDEV::XferMsg(DWORD msg)
{
	ASSERT(this);
